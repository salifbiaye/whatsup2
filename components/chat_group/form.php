<form method="post" enctype="multipart/form-data" class="flex items-center gap-2 mt-2 bg-white dark:bg-gray-900 rounded-full px-3 py-2 shadow border dark:border-gray-700" id="chat-form">
    ...
    <input type="text" name="message" id="chat-input" placeholder="Votre message..." autocomplete="off" class="flex-1 px-4 py-2 bg-transparent border-none focus:ring-0 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 outline-none" />
