    ...
    <div class="mt-6">
        ...
        <ul class="divide-y divide-gray-200 dark:divide-gray-700">
            <?php foreach ($groups as $group): ?>
                <li>
                    <a href="/whatsup/chat_group?group=<?php echo urlencode($group['id']); ?>" class="flex items-center gap-3 px-2 py-2 hover:bg-amber-50 dark:hover:bg-gray-800 rounded transition">
