<div class="mx-auto bg-white h-screen dark:bg-gray-900 flex flex-col">
    ...
    <!-- Messages Container -->
    <div class="flex-1 overflow-y-auto px-4 py-2 bg-[url('/whatsup/assets/logo/bg-light-chat.png')] dark:bg-[url('/whatsup/assets/logo/bg-dark-chat.png')] dark:bg-gray-800" id="messages-box"> <?php if (empty($messages)): ?>
